...
Route::get('/verificar','VerificarMailController@index')->name('verificar.index')->middleware('auth');
Route::get('/verificado','VerificarMailController@verificado')->name('verificar.verificado')->middleware('auth');
...
Route::post('/personal/listar','PersonalController@listar')->name('alumno.listar');
Route::post('/personal/agregarPreceptorCurso','PersonalController@agregarPreceptorCurso')->name('alumno.agregarPreceptorCurso');
Route::post('/personal/asignarDocenteMateria','PersonalController@asignarDocenteMateria')->name('alumno.asignarDocenteMateria');
